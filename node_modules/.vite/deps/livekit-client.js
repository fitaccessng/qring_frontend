...
var AudioCodec = /* @__PURE__ */ proto3.makeEnum("livekit.AudioCodec", [
	{
		no: 0,
		name: "DEFAULT_AC"
	},
...
var VideoCodec = /* @__PURE__ */ proto3.makeEnum("livekit.VideoCodec", [
	{
		no: 0,
		name: "DEFAULT_VC"
	},
...
var ImageCodec = /* @__PURE__ */ proto3.makeEnum("livekit.ImageCodec", [{
	no: 0,
	name: "IC_DEFAULT"
}, {
	no: 1,
...
var FilterParams = /* @__PURE__ */ proto3.makeMessageType("livekit.FilterParams", () => [{
	no: 1,
	name: "include_events",
	kind: "scalar",
	T: 9,
...
var WebhookConfig = /* @__PURE__ */ proto3.makeMessageType("livekit.WebhookConfig", () => [
	{
		no: 1,
		name: "url",
		kind: "scalar",
...
var JobRestartPolicy = /* @__PURE__ */ proto3.makeEnum("livekit.JobRestartPolicy", [{
	no: 0,
	name: "JRP_ON_FAILURE"
}, {
	no: 1,
...
var RoomAgentDispatch = /* @__PURE__ */ proto3.makeMessageType("livekit.RoomAgentDispatch", () => [
	{
		no: 1,
		name: "agent_name",
		kind: "scalar",
...
var EncodingOptionsPreset = /* @__PURE__ */ proto3.makeEnum("livekit.EncodingOptionsPreset", [
	{
		no: 0,
		name: "H264_720P_30"
	},
...
var EncodedFileType = /* @__PURE__ */ proto3.makeEnum("livekit.EncodedFileType", [
	{
		no: 0,
...
var StreamProtocol = /* @__PURE__ */ proto3.makeEnum("livekit.StreamProtocol", [
	{
		no: 0,
...
var SegmentedFileProtocol = /* @__PURE__ */ proto3.makeEnum("livekit.SegmentedFileProtocol", [{
	no: 0,
...
var SegmentedFileSuffix = /* @__PURE__ */ proto3.makeEnum("livekit.SegmentedFileSuffix", [{
	no: 0,
	name: "INDEX"
}, {
	no: 1,
...
var ImageFileSuffix = /* @__PURE__ */ proto3.makeEnum("livekit.ImageFileSuffix", [
	{
		no: 0,
...
var AudioMixing = /* @__PURE__ */ proto3.makeEnum("livekit.AudioMixing", [
	{
		no: 0,
		name: "DEFAULT_MIXING"
	},
...
var EncodingOptions = /* @__PURE__ */ proto3.makeMessageType("livekit.EncodingOptions", () => [
	{
		no: 1,
		name: "width",
		kind: "scalar",
...
var StreamOutput = /* @__PURE__ */ proto3.makeMessageType("livekit.StreamOutput", () => [{
	no: 1,
	name: "protocol",
	kind: "enum",
...
var SegmentedFileOutput = /* @__PURE__ */ proto3.makeMessageType("livekit.SegmentedFileOutput", () => [
	{
		no: 1,
		name: "protocol",
		kind: "enum",
...
var ImageOutput = /* @__PURE__ */ proto3.makeMessageType("livekit.ImageOutput", () => [
	{
		no: 1,
...
var S3Upload = /* @__PURE__ */ proto3.makeMessageType("livekit.S3Upload", () => [
	{
		no: 1,
		name: "access_key",
		kind: "scalar",
...
var GCPUpload = /* @__PURE__ */ proto3.makeMessageType("livekit.GCPUpload", () => [
	{
		no: 1,
		name: "credentials",
		kind: "scalar",
...
var AzureBlobUpload = /* @__PURE__ */ proto3.makeMessageType("livekit.AzureBlobUpload", () => [
	{
		no: 1,
		name: "account_name",
		kind: "scalar",
...
var AliOSSUpload = /* @__PURE__ */ proto3.makeMessageType("livekit.AliOSSUpload", () => [
	{
		no: 1,
		name: "access_key",
		kind: "scalar",
...
var ProxyConfig = /* @__PURE__ */ proto3.makeMessageType("livekit.ProxyConfig", () => [
	{
		no: 1,
		name: "url",
		kind: "scalar",
...
var AutoParticipantEgress = /* @__PURE__ */ proto3.makeMessageType("livekit.AutoParticipantEgress", () => [
	{
		no: 1,
		name: "preset",
		kind: "enum",
...
var AutoTrackEgress = /* @__PURE__ */ proto3.makeMessageType("livekit.AutoTrackEgress", () => [
	{
		no: 1,
		name: "filepath",
		kind: "scalar",
...
var RoomCompositeEgressRequest = /* @__PURE__ */ proto3.makeMessageType("livekit.RoomCompositeEgressRequest", () => [
	{
		no: 1,
		name: "room_name",
		kind: "scalar",
...
var EncodedFileOutput = /* @__PURE__ */ proto3.makeMessageType("livekit.EncodedFileOutput", () => [
	{
		no: 1,
		name: "file_type",
		kind: "enum",
...
var RoomEgress = /* @__PURE__ */ proto3.makeMessageType("livekit.RoomEgress", () => [
	{
		no: 1,
		name: "room",
		kind: "message",
...
var RoomConfiguration = /* @__PURE__ */ proto3.makeMessageType("livekit.RoomConfiguration", () => [
	{
		no: 1,
		name: "name",
		kind: "scalar",
...
var TokenSourceRequest = /* @__PURE__ */ proto3.makeMessageType("livekit.TokenSourceRequest", () => [
	{
		no: 1,
		name: "room_name",
		kind: "scalar",
...
var TokenSourceResponse = /* @__PURE__ */ proto3.makeMessageType("livekit.TokenSourceResponse", () => [{
	no: 1,
	name: "server_url",
	kind: "scalar",
	T: 9
...
function setLogLevel(level, loggerName) {
	if (loggerName) loglevelExports.getLogger(loggerName).setLevel(level);
	else for (const logger of livekitLoggers) logger.setLevel(level);
}
/**
...
function setLogExtension(extension, logger) {
	(logger ? [logger] : livekitLoggers).forEach((logR) => {
		...
		logR.methodFactory = (methodName, configLevel, loggerName) => {
			...
			return (msg, context) => {
				...
				if (needLog) extension(logLevel, msg, context);
			};
		};
...
function getEmptyVideoStreamTrack() {
	if (!emptyVideoStreamTrack) emptyVideoStreamTrack = createDummyVideoStreamTrack();
...
function createAudioAnalyser(track, options) {
	...
	if (!audioContext) throw new Error("Audio Context not supported on this browser");
	...
	*/
	const calculateVolume = () => {
		...
		let sum = 0;
		for (const amplitude of dataArray) sum += Math.pow(amplitude / 255, 2);
		return Math.sqrt(sum / dataArray.length);
	};
	const cleanup = () => __awaiter(this, void 0, void 0, function* () {
		yield audioContext.close();
		if (opts.cloneTrack) streamTrack.stop();
	});
	return {
		calculateVolume,
		analyser,
...
function importKey(keyBytes_1) {
	return __awaiter(this, arguments, void 0, function(keyBytes) {
		let algorithm = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : { name: ENCRYPTION_ALGORITHM };
...
function createKeyMaterialFromString(password) {
	return __awaiter(this, void 0, void 0, function* () {
		...
		return yield crypto.subtle.importKey("raw", enc.encode(password), { name: "PBKDF2" }, false, ["deriveBits", "deriveKey"]);
	});
}
function createKeyMaterialFromBuffer(cryptoBuffer) {
	return __awaiter(this, void 0, void 0, function* () {
		return yield crypto.subtle.importKey("raw", cryptoBuffer, "HKDF", false, ["deriveBits", "deriveKey"]);
	});
}
function getAlgoOptions(algorithmName, salt) {
	...
	switch (algorithmName) {
		case "HKDF": return {
			...
			salt: encodedSalt,
			hash: "SHA-256",
			info: /* @__PURE__ */ new ArrayBuffer(128)
		};
		case "PBKDF2": return {
			name: "PBKDF2",
			salt: encodedSalt,
		...
		default: throw new Error("algorithm ".concat(algorithmName, " is currently unsupported"));
	}
}
/**
...
function deriveKeys(material, options) {
	return __awaiter(this, void 0, void 0, function* () {
		...
		return {
			material,
			encryptionKey: yield crypto.subtle.deriveKey(algorithmOptions, material, {
...
function needsRbspUnescaping(frameData) {
	for (var i = 0; i < frameData.length - 3; i++) if (frameData[i] == 0 && frameData[i + 1] == 0 && frameData[i + 2] == 3) return true;
	return false;
}
function parseRbsp(stream) {
	const dataOut = [];
	var length = stream.length;
	for (var i = 0; i < stream.length;) if (length - i >= 3 && !stream[i] && !stream[i + 1] && stream[i + 2] == 3) {
		dataOut.push(stream[i++]);
		dataOut.push(stream[i++]);
		i++;
	} else dataOut.push(stream[i++]);
...
function writeRbsp(data_in) {
	...
	for (var i = 0; i < data_in.length; ++i) {
		...
		dataOut.push(byte);
		if (byte == 0) ++numConsecutiveZeros;
		else numConsecutiveZeros = 0;
	}
	return new Uint8Array(dataOut);
}
...
var BaseKeyProvider = class extends eventsExports.EventEmitter {
	...
	*/
	onSetEncryptionKey(key, participantIdentity, keyIndex) {
		...
		if (!this.options.sharedKey && !participantIdentity) throw new Error("participant identity needs to be passed for encryption key if sharedKey option is false");
		this.keyInfoMap.set("".concat(participantIdentity !== null && participantIdentity !== void 0 ? participantIdentity : "shared", "-").concat(keyIndex !== null && keyIndex !== void 0 ? keyIndex : 0), keyInfo);
		if (keyIndex !== void 0) this.latestManuallySetKeyIndex = keyIndex;
		...
		return __awaiter(this, arguments, void 0, function() {
			...
			return function* () {
				...
				try {
					...
					_this3.log.debug("websocket error while closing", Object.assign(Object.assign({}, _this3.logContext), { error: e }));
				} finally {
		...
		return __awaiter(this, arguments, void 0, function(message) {
			...
			return function* () {
				...
				try {
					...
					else yield _this5.streamWriter.write(req.toBinary());
				} catch (e) {
					_this5.log.error("error sending signal message", Object.assign(Object.assign({}, _this5.logContext), { error: e }));
				}
			}();
		});
	}
	...
	handleConnectionError(reason, validateUrl) {
		return __awaiter(this, void 0, void 0, function* () {
			try {
				...
				switch (resp.status) {
					case 404: return ConnectionError.serviceNotFound("v1 RTC path not found. Consider upgrading your LiveKit server version", "v0-rtc");
					case 401:
					case 403:
...
var RTCEngine = class extends eventsExports.EventEmitter {
		...
		return __awaiter(this, arguments, void 0, function(url, token, opts, abortSignal) {
			...
			return function* () {
				...
				try {
					...
					if (!useV0Path && isCompressionStreamSupported()) (_c = _this2.pcManager) === null || _c === void 0 || _c.updateConfiguration(_this2.makeRTCConfiguration(joinResponse));
					else {
						if (!_this2.pcManager) yield _this2.configure(joinResponse, !useV0Path);
	...
	*/
	...
	addMediaSections(numAudios, numVideos) {
		...
		for (let i = 0; i < numVideos; i++) (_b = this.pcManager) === null || _b === void 0 || _b.addPublisherTransceiverOfKind("video", transceiverInit);
	}
	createDataChannels() {
		if (!this.pcManager) return;
		if (this.lossyDC) {
	...
	sendDataPacket(packet, kind) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			switch (kind) {
				...
				case DataChannelKind.DATA_TRACK_LOSSY: return this.sendLossyBytes(msg, kind);
	...
	sendLossyBytes(bytes_1, kind_1) {
		return __awaiter(this, arguments, void 0, function(bytes, kind) {
			...
			return function* () {
				...
				if (dc) {
					if (!_this3.isBufferStatusLow(kind)) switch (bufferStatusLowBehavior) {
						case "wait":
							yield _this3.waitForBufferStatusLow(kind);
							break;
						case "drop":
							_this3.lossyDataDropCount += 1;
							if (_this3.lossyDataDropCount % 100 === 0) _this3.log.warn("dropping lossy data channel messages, total dropped: ".concat(_this3.lossyDataDropCount), _this3.logContext);
							return;
					}
					_this3.lossyDataStatCurrentBytes += bytes.byteLength;
					if (_this3.attemptingReconnect) return;
					dc.send(bytes);
				}
	...
	waitForBufferStatusLow(kind) {
		return __awaiter(this, void 0, void 0, function* () {
			return new TypedPromise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
				if (this.isClosed) reject(new UnexpectedConnectionState("engine closed"));
	...
	*/
	ensureDataTransportConnected(kind_1) {
		return __awaiter(this, arguments, void 0, function(kind) {
			...
			return function* () {
				var _a;
				if (!_this4.pcManager) throw new UnexpectedConnectionState("PC manager is closed");
				...
				if (!needNegotiation && !subscriber && !_this4.pcManager.publisher.isICEConnected && _this4.pcManager.publisher.getICEConnectionState() !== "checking") needNegotiation = true;
				if (needNegotiation) _this4.negotiate().catch((err) => {
				...
				while ((/* @__PURE__ */ new Date()).getTime() < endTime) {
					if (transport.isICEConnected && ((_a = _this4.dataChannelForKind(kind, subscriber)) === null || _a === void 0 ? void 0 : _a.readyState) === "open") return;
					yield sleep(50);
				}
	...
	verifyTransport() {
		...
		if (![PCTransportState.CONNECTING, PCTransportState.CONNECTED].includes(this.pcManager.currentState)) return false;
	...
	negotiate() {
		return __awaiter(this, void 0, void 0, function* () {
			return new TypedPromise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
				...
				if (this.pcManager.publisher.getTransceivers().length == 0 && !this.lossyDC && !this.reliableDC && !this.dataTrackDC) this.createDataChannels();
	...
	dataChannelForKind(kind, sub) {
		switch (kind) {
			case DataChannelKind.RELIABLE: if (!sub) return this.reliableDC;
			else return this.reliableDCSub;
			case DataChannelKind.LOSSY: if (!sub) return this.lossyDC;
			else return this.lossyDCSub;
			case DataChannelKind.DATA_TRACK_LOSSY: if (!sub) return this.dataTrackDC;
			else return this.dataTrackDCSub;
		}
	}
	/** @internal */
...
var IncomingDataStreamManager = class {
	...
	flushBufferedPackets() {
		...
		this.bufferedPackets = [];
		for (const { packet, encryptionType } of packets) this.handleDataStreamPacket(packet, encryptionType);
	}
	...
	handleStreamHeader(streamHeader, participantIdentity, encryptionType) {
		...
		if (streamHeader.contentHeader.case === "byteHeader") {
			...
			} }), bigIntToNumber(streamHeader.totalLength)), { identity: participantIdentity });
...
var DataTrackPacketHeader = class DataTrackPacketHeader extends Serializable {
	...
	extensionsMetrics() {
		...
		return {
			lengthBytes,
			lengthWords,
			paddingLengthBytes: lengthWords * 4 - lengthBytes
		};
	}
	toBinaryLengthBytes() {
	...
	toBinaryInto(dataView) {
		...
		const { lengthBytes: extensionsLengthBytes, lengthWords: extensionsLengthWords, paddingLengthBytes: extensionsPaddingLengthBytes } = this.extensionsMetrics();
		if (extensionsLengthBytes > 0) initial |= 1 << EXT_FLAG_SHIFT;
		let byteIndex = 0;
	...
	static fromBinary(input) {
		...
		if (extensionsFlag) {
			...
			byteIndex += U16_LENGTH_BYTES;
			let extensionLengthBytes = 4 * (rtpOrientedExtensionWords + 1);
...
var DataTrackDepacketizer = class DataTrackDepacketizer {
	...
	* is returned.*/
	...
	frameFromSingle(packet, options) {
		...
		if (this.partial) if (options === null || options === void 0 ? void 0 : options.errorOnPartialFrames) {
		...
		} else log$3.warn("Data track frame ".concat(this.partial.frameNumber, " was interrupted by the start of a new frame, dropping."));
		this.reset();
		return {
	...
	beginPartial(packet, options) {
		...
		if (this.partial) if (options === null || options === void 0 ? void 0 : options.errorOnPartialFrames) {
			...
			this.reset();
			throw DataTrackDepacketizerDropError.interrupted(frameNumber, packet.header.frameNumber.value);
		} else log$3.warn("Data track frame ".concat(this.partial.frameNumber, " was interrupted by the start of a new frame ").concat(packet.header.frameNumber.value, ", dropping."));
		this.reset();
	...
	pushToPartial(packet) {
		...
		if (this.partial.payloads.has(packet.header.sequence.value)) log$3.warn("Data track frame ".concat(this.partial.frameNumber, " received duplicate packet for sequence ").concat(packet.header.sequence.value, ", so replacing with newly received packet."));
		this.partial.payloads.set(packet.header.sequence.value, packet.payload);
		if (packet.header.marker === FrameMarker.Final) return this.finalize(this.partial, packet.header.sequence.value);
		return null;
	}
...
var IncomingDataTrackManager = class extends eventsExports.EventEmitter {
		...
		return [new ReadableStream({
			start: (controller) => {
				...
				this.subscribeRequest(sid, signal).then(() => __awaiter(this, void 0, void 0, function* () {
					...
					(_a = sfuSubscriptionComplete.resolve) === null || _a === void 0 || _a.call(sfuSubscriptionComplete);
				})).catch((err) => {
					var _a;
	...
	* @internal */
	...
	unSubscribeRequest(sid) {
		...
		for (const controller of descriptor.subscription.streamControllers) controller.close();
		const previousDescriptorSubscription = descriptor.subscription;
		descriptor.subscription = { type: "none" };
	...
	receiveSfuPublicationUpdates(updates) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			for (const [publisherIdentity, sidsInUpdate] of publisherParticipantToSidsInUpdate.entries()) {
				let unpublishedSids = Array.from(this.descriptors.entries()).filter((_ref) => {
	...
	* @internal */
	...
	receivedSfuSubscriberHandles(mapping) {
		for (const [handle, sid] of mapping.entries()) this.registerSubscriberHandle(handle, sid);
	}
	...
	*/
	resendSubscriptionUpdates() {
		for (const [sid, descriptor] of this.descriptors) {
			if (descriptor.subscription.type === "none") continue;
			this.emit("sfuUpdateSubscription", {
				sid,
				subscribe: true
			});
	...
	* cancelled. */
	...
	shutdown() {
		...
		for (const descriptor of this.descriptors.values()) {
			...
			if (descriptor.subscription.type === "active") descriptor.subscription.streamControllers.forEach((controller) => controller.close());
		}
...
var OutgoingDataTrackManager = class OutgoingDataTrackManager extends eventsExports.EventEmitter {
	...
	receivedSfuPublishResponse(handle, result) {
		...
		switch (descriptor.type) {
			case "pending":
				...
				} else (_d = (_c = descriptor.completionFuture).reject) === null || _d === void 0 || _d.call(_c, result.error);
				return;
			case "active":
	...
	*/
	sfuWillRepublishTracks() {
		var _a, _b;
		for (const [handle, descriptor] of this.descriptors.entries()) switch (descriptor.type) {
			case "pending":
				this.descriptors.delete(handle);
...
var DeferrableMap = class extends Map {
	...
	set(key, value) {
		...
		if (futures) {
			for (const future of futures) if (!future.isResolved) (_a = future.resolve) === null || _a === void 0 || _a.call(future, value);
...
var RemoteParticipant = class RemoteParticipant extends Participant {
	...
	*/
	...
	removeRemoteDataTrack(remoteDataTrackSid) {
		for (const [name, dataTrack] of this.dataTracks.entries()) if (remoteDataTrackSid === dataTrack.info.sid) this.dataTracks.delete(name);
	}
	/** @internal */
	emit(event) {
...
var Room = class Room extends eventsExports.EventEmitter {
	...
	constructor(options) {
		...
		*/
		...
		this.connectSignal = (url, token, engine, connectOptions, roomOptions, abortController) => __awaiter(this, void 0, void 0, function* () {
			const { joinResponse, serverInfo } = yield engine.join(url, token, {
		...
		*/
		...
		if ((_d = this.options.audioOutput) === null || _d === void 0 ? void 0 : _d.deviceId) this.switchActiveDevice("audiooutput", unwrapConstraint(this.options.audioOutput.deviceId)).catch((e) => this.log.warn("Could not set audio output: ".concat(e.message), this.logContext));
		if (isWeb()) {
			const abortController = new AbortController();
			(_f = (_e = navigator.mediaDevices) === null || _e === void 0 ? void 0 : _e.addEventListener) === null || _f === void 0 || _f.call(_e, "devicechange", this.handleDeviceChange, { signal: abortController.signal });
	...
	*/
	...
	onTrackAdded(mediaTrack, stream, receiver) {
		...
		if (!participant) {
			if (participantSid.startsWith("PA")) this.log.error("Tried to add a track for a participant, that's not present. Sid: ".concat(participantSid), this.logContext);
			return;
		}
...
var Checker = class extends eventsExports.EventEmitter {
	...
	run(onComplete) {
		return __awaiter(this, void 0, void 0, function* () {
			if (this.status !== CheckStatus.IDLE) throw Error("check is running already");
			this.setStatus(CheckStatus.RUNNING);
			try {
				yield this.perform();
			} catch (err) {
				if (err instanceof Error) if (this.options.errorsAsWarnings) this.appendWarning(err.message);
				else this.appendError(err.message);
			}
			yield this.disconnect();
			yield new Promise((resolve) => setTimeout(resolve, 500));
			if (this.status !== CheckStatus.SKIPPED) this.setStatus(this.isSuccess() ? CheckStatus.SUCCESS : CheckStatus.FAILED);
...
var CloudRegionCheck = class extends Checker {
	...
	perform() {
		return __awaiter(this, void 0, void 0, function* () {
			...
			for (let i = 0; i < 3; i++) {
				...
				if (!regionUrl) break;
				if (seenUrls.has(regionUrl)) continue;
			...
			regionStats.sort((a, b) => {
				return (a.duration - b.duration) * .5 + (a.rtt - b.rtt) * .5;
			});
	...
	checkCloudRegion(url) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			if (this.options.protocol === "tcp") yield this.switchProtocol("tcp");
			const region = (_a = this.room.serverInfo) === null || _a === void 0 ? void 0 : _a.region;
			if (!region) throw new Error("Region not found");
			const writer = yield this.room.localParticipant.streamText({ topic: "test" });
			const chunkSize = 1e3;
			const numChunks = 1e6 / chunkSize;
			const chunkData = "A".repeat(chunkSize);
			const startTime = Date.now();
			for (let i = 0; i < numChunks; i++) yield writer.write(chunkData);
			yield writer.close();
			...
			stats === null || stats === void 0 || stats.forEach((stat) => {
				if (stat.type === "candidate-pair" && stat.nominated) regionStats.rtt = stat.currentRoundTripTime * 1e3;
			});
			yield this.disconnect();
			return regionStats;
		});
...
var ConnectionProtocolCheck = class extends Checker {
	...
	perform() {
		return __awaiter(this, void 0, void 0, function* () {
			...
			if (udpStats.qualityLimitationDurations.bandwidth - tcpStats.qualityLimitationDurations.bandwidth > .5 || (udpStats.packetsLost - tcpStats.packetsLost) / udpStats.packetsSent > .01) {
				this.appendMessage("best connection quality via tcp");
				this.bestStats = tcpStats;
			} else this.appendMessage("best connection quality via udp");
			...
			if (stats.packetsLost > 0) this.appendWarning("packets lost: ".concat((stats.packetsLost / stats.packetsSent * 100).toFixed(2), "%"));
			if (stats.qualityLimitationDurations.bandwidth > 1) this.appendWarning("bandwidth limited ".concat((stats.qualityLimitationDurations.bandwidth / (TEST_DURATION / 1e3) * 100).toFixed(2), "%"));
			if (stats.qualityLimitationDurations.cpu > 0) this.appendWarning("cpu limited ".concat((stats.qualityLimitationDurations.cpu / (TEST_DURATION / 1e3) * 100).toFixed(2), "%"));
		});
	}
	getInfo() {
		const info = super.getInfo();
	...
	checkConnectionProtocol(protocol) {
		return __awaiter(this, void 0, void 0, function* () {
			yield this.connect();
			if (protocol === "tcp") yield this.switchProtocol("tcp");
			else yield this.switchProtocol("udp");
			const canvas = document.createElement("canvas");
			canvas.width = 1280;
			canvas.height = 720;
			const ctx = canvas.getContext("2d");
			...
			const track = (yield this.room.localParticipant.publishTrack(videoTrack, {
				simulcast: false,
...
var PublishAudioCheck = class extends Checker {
	...
	perform() {
		return __awaiter(this, void 0, void 0, function* () {
			...
			if (yield detectSilence(track, 1e3)) throw new Error("unable to detect audio from microphone");
			this.appendMessage("detected audio from microphone");
			room.localParticipant.publishTrack(track);
			yield new Promise((resolve) => setTimeout(resolve, 3e3));
			const stats = yield (_a = track.sender) === null || _a === void 0 ? void 0 : _a.getStats();
			if (!stats) throw new Error("Could not get RTCStats");
			let numPackets = 0;
			stats.forEach((stat) => {
				if (stat.type === "outbound-rtp" && (stat.kind === "audio" || !stat.kind && stat.mediaType === "audio")) numPackets = stat.packetsSent;
			});
			if (numPackets === 0) throw new Error("Could not determine packets are sent");
...
var PublishVideoCheck = class extends Checker {
	...
	perform() {
		return __awaiter(this, void 0, void 0, function* () {
			...
			let numPackets = 0;
			stats.forEach((stat) => {
				if (stat.type === "outbound-rtp" && (stat.kind === "video" || !stat.kind && stat.mediaType === "video")) numPackets += stat.packetsSent;
			});
			if (numPackets === 0) throw new Error("Could not determine packets are sent");
			...
			yield new Promise((resolve) => {
				video.onplay = () => {
					setTimeout(() => {
						...
						let isAllBlack = true;
						for (let i = 0; i < data.length; i += 4) if (data[i] !== 0 || data[i + 1] !== 0 || data[i + 2] !== 0) {
							isAllBlack = false;
							break;
						}
						if (isAllBlack) this.appendError("camera appears to be producing only black frames");
						else this.appendMessage("received video frames");
						resolve();
					}, 1e3);
				};
				video.play();
...
var ReconnectCheck = class extends Checker {
	...
	perform() {
		return __awaiter(this, void 0, void 0, function* () {
			...
			(_a = room.engine.client.ws) === null || _a === void 0 || _a.close();
			const onClose = room.engine.client.onClose;
			if (onClose) onClose("");
			yield reconnectTimeout;
			if (!reconnectingTriggered) throw new Error("Did not attempt to reconnect");
...
var TURNCheck = class extends Checker {
	...
	perform() {
		return __awaiter(this, void 0, void 0, function* () {
			...
			let hasTURN = false;
			let hasSTUN = false;
			for (let iceServer of joinRes.iceServers) for (let url of iceServer.urls) {
			...
			if (!hasSTUN) this.appendWarning("No STUN servers configured on server side.");
			else if (hasTURN && !hasTLS) this.appendWarning("TURN is configured server side, but TURN/TLS is unavailable.");
			yield signalClient.close();
			if (((_c = (_b = this.connectOptions) === null || _b === void 0 ? void 0 : _b.rtcConfig) === null || _c === void 0 ? void 0 : _c.iceServers) || hasTURN) yield this.room.connect(this.url, this.token, { rtcConfig: { iceTransportPolicy: "relay" } });
			else {
...
var WebRTCCheck = class extends Checker {
	...
	perform() {
		return __awaiter(this, void 0, void 0, function* () {
				...
				this.room.engine.client.onTrickle = (sd, target) => {
					if (sd.candidate) {
						...
						if (candidate.address) {
							if (isIPPrivate(candidate.address)) str += " (private)";
							else if (candidate.protocol === "tcp" && candidate.tcpType === "passive") {
								hasTcp = true;
								str += " (passive)";
							} else if (candidate.protocol === "udp") hasIpv4Udp = true;
						}
						this.appendMessage(str);
					}
					if (prevTrickle) prevTrickle(sd, target);
				};
				if ((_a = this.room.engine.pcManager) === null || _a === void 0 ? void 0 : _a.subscriber) this.room.engine.pcManager.subscriber.onIceCandidateError = (ev) => {
					if (ev instanceof RTCPeerConnectionIceErrorEvent) this.appendWarning("error with ICE candidate: ".concat(ev.errorCode, " ").concat(ev.errorText, " ").concat(ev.url));
				};
			});
			try {
				yield this.connect();
			...
			if (!hasTcp) this.appendWarning("Server is not configured for ICE/TCP");
			if (!hasIpv4Udp) this.appendWarning("No public IPv4 UDP candidates were found. Your server is likely not configured correctly");
		});
	}
};
function isIPPrivate(address) {
	...
	if (parts.length === 4) {
		...
		else if (parts[0] === "192" && parts[1] === "168") return true;
		else if (parts[0] === "172") {
...
var WebSocketCheck = class extends Checker {
	...
	perform() {
		return __awaiter(this, void 0, void 0, function* () {
			var _a, _b, _c;
			if (this.url.startsWith("ws:") || this.url.startsWith("http:")) this.appendWarning("Server is insecure, clients may block connections to it");
			...
			try {
				...
				if (isCloud(new URL(this.url))) {
					...
					const regionUrl = yield new RegionUrlProvider(this.url, this.token).getNextBestRegionUrl();
					if (regionUrl) {
			...
			if (joinRes) {
				...
				if (((_a = joinRes.serverInfo) === null || _a === void 0 ? void 0 : _a.edition) === ServerInfo_Edition.Cloud && ((_b = joinRes.serverInfo) === null || _b === void 0 ? void 0 : _b.region)) this.appendMessage("LiveKit Cloud: ".concat((_c = joinRes.serverInfo) === null || _c === void 0 ? void 0 : _c.region));
			} else this.appendError("Websocket connection could not be established");
			yield signalClient.close();
		});
	}
};
...
function isResponseTokenValid(response) {
	...
	if (!(jwtPayload === null || jwtPayload === void 0 ? void 0 : jwtPayload.nbf) || !(jwtPayload === null || jwtPayload === void 0 ? void 0 : jwtPayload.exp)) return true;
...
function decodeTokenPayload(token) {
	...
	const { roomConfig } = payload, rest = __rest(payload, ["roomConfig"]);
	return Object.assign(Object.assign({}, rest), { roomConfig: payload.roomConfig ? RoomConfiguration.fromJson(payload.roomConfig, { ignoreUnknownFields: true }) : void 0 });
}
...
function areTokenSourceFetchOptionsEqual(a, b) {
	...
	for (const key of allKeysSet) switch (key) {
		case "roomName":
...
var TokenSourceCached = class extends TokenSourceConfigurable {
	...
	isSameAsCachedFetchOptions(options) {
		...
		for (const key of Object.keys(this.cachedFetchOptions)) switch (key) {
			case "roomName":
			case "participantName":
			case "participantIdentity":
			case "participantMetadata":
			...
			case "agentName":
			case "agentMetadata":
				if (this.cachedFetchOptions[key] !== options[key]) return false;
				break;
			default:
				const exhaustiveCheckedKey = key;
				throw new Error("Options key ".concat(exhaustiveCheckedKey, " not being checked for equality!"));
	...
	shouldReturnCachedValueFromFetch(fetchOptions) {
		if (!this.cachedResponse) return false;
		if (!isResponseTokenValid(this.cachedResponse)) return false;
		if (!this.isSameAsCachedFetchOptions(fetchOptions)) return false;
		return true;
	}
	getCachedResponseJwtPayload() {
		if (!this.cachedResponse) return null;
	...
	fetch(options, force) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			try {
				if (force) this.cachedResponse = null;
				if (this.shouldReturnCachedValueFromFetch(options)) return this.cachedResponse.toJson();
...
var TokenSourceLiteral = class extends TokenSourceFixed {
	...
	fetch() {
		return __awaiter(this, void 0, void 0, function* () {
			if (typeof this.literalOrFn === "function") return this.literalOrFn();
			else return this.literalOrFn;
		});
	}
};
var TokenSourceCustom = class extends TokenSourceCached {
	...
	update(options) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			let result;
			if (resultMaybePromise instanceof Promise) result = yield resultMaybePromise;
			else result = resultMaybePromise;
			return TokenSourceResponse.fromJson(result, { ignoreUnknownFields: true });
		});
	}
};
var TokenSourceEndpoint = class extends TokenSourceCached {
	...
	createRequestFromOptions(options) {
		...
		for (const key of Object.keys(options)) switch (key) {
			case "roomName":
			case "participantName":
			case "participantIdentity":
			case "participantMetadata":
			...
			case "agentName":
				...
				if (request.roomConfig.agents.length === 0) request.roomConfig.agents.push(new RoomAgentDispatch());
	...
	update(options) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			const response = yield fetch(this.url, Object.assign(Object.assign({}, this.endpointOptions), {
				...
				headers: Object.assign({ "Content-Type": "application/json" }, this.endpointOptions.headers),
				body: request.toJsonString({ useProtoFieldName: true })
			}));
			if (!response.ok) throw new Error("Error generating token from endpoint ".concat(this.url, ": received ").concat(response.status, " / ").concat(yield response.text()));
			const body = yield response.json();
			return TokenSourceResponse.fromJson(body, { ignoreUnknownFields: true });
		});
	}
};
var TokenSourceSandboxTokenServer = class extends TokenSourceEndpoint {
	constructor(sandboxId, options) {
		const { baseUrl = "https://cloud-api.livekit.io" } = options, rest = __rest(options, ["baseUrl"]);
		super("".concat(baseUrl, "/api/v2/sandbox/connection-details"), Object.assign(Object.assign({}, rest), { headers: { "X-Sandbox-ID": sandboxId } }));
	}
};
var TokenSource = {
	literal(literalOrFn) {
	...
	endpoint(url) {
		return new TokenSourceEndpoint(url, arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {});
	},
	sandboxTokenServer(sandboxId) {
		return new TokenSourceSandboxTokenServer(sandboxId, arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {});
	}
};
function facingModeFromLocalTrack(localTrack) {
	...
	if ("facingMode" in trackSettings) {
		...
		livekitLogger.trace("rawFacingMode", { rawFacingMode });
		if (rawFacingMode && typeof rawFacingMode === "string" && isFacingModeValue(rawFacingMode)) result = {
	...
	if (["low", "medium"].includes(result.confidence)) {
		...
		if (labelAnalysisResult !== void 0) result = labelAnalysisResult;
	}
	return result;
}
...
function facingModeFromDeviceLabel(deviceLabel) {
	...
	if (label === "") return;
	if (knownDeviceLabels.has(label)) return knownDeviceLabels.get(label);
...
function base(params) {
	return Object.assign(Object.assign({}, params), { symbol: SerializerSymbol });
}
/**
