    ...
    <div className="min-h-screen bg-white text-slate-900 dark:bg-slate-950 dark:text-slate-100">
      ...
      <main className="mx-auto w-full max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-10">
        <div className="text-center">
          ...
          <h1 className="mt-6 text-4xl font-black tracking-tight sm:text-5xl lg:text-6xl">Legal</h1>
          <p className="mt-6 text-lg leading-relaxed text-slate-600 dark:text-slate-300">
            Legal information and documentation coming soon. Check back for Privacy, Terms, and Compliance information.
          </p>
