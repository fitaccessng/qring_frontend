...
export default function LandingShell({ children }) {
  ...
  return (
    <div className="min-h-screen bg-[#f7f3ee] text-slate-900 dark:bg-[#0d1117] dark:text-slate-100">
      <div className="pointer-events-none fixed inset-0 -z-10 bg-[radial-gradient(circle_at_15%_12%,rgba(20,184,166,0.18),transparent_45%),radial-gradient(circle_at_85%_80%,rgba(14,116,144,0.18),transparent_42%)]" />
      <header className="sticky top-0 z-50 border-b border-slate-200/70 bg-[#f7f3ee]/80 backdrop-blur dark:border-slate-800/60 dark:bg-[#0d1117]/80">
        <nav className="mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-10">
          <Link to="/" className="flex items-center gap-3">
            <span className="grid h-11 w-11 place-items-center rounded-xl bg-slate-900 text-white shadow-sm dark:bg-white dark:text-slate-900">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              to="/login"
              className="hidden rounded-full border border-slate-300 px-4 py-2 text-xs font-semibold text-slate-800 transition hover:bg-white md:inline-flex dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-800"
            >
              Login
            </Link>
            <Link
      ...
      <footer className="mt-16 border-t border-slate-200/70 bg-white/70 py-12 dark:border-slate-800 dark:bg-slate-950/40">
            ...
            <div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">Smart Access</p>
                </div>
              </div>
              ...
              <div className="mt-4 flex flex-wrap gap-2 text-xs font-semibold text-slate-500">
                <span className="rounded-full border border-slate-200 px-3 py-1 dark:border-slate-700">Realtime alerts</span>
                <span className="rounded-full border border-slate-200 px-3 py-1 dark:border-slate-700">Visitor verification</span>
                <span className="rounded-full border border-slate-200 px-3 py-1 dark:border-slate-700">Estate ops</span>
              </div>
            </div>
