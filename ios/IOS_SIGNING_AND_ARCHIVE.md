...
- an iPhone Distribution or Apple Distribution certificate
- a matching provisioning profile for `com.qring.ng.app`
...
xcodebuild \
  ...
  PRODUCT_BUNDLE_IDENTIFIER=com.qring.ng.app \
...
- If archive fails on signing:
  ...
  - confirm bundle id `com.qring.ng.app`
